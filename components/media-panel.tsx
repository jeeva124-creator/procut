...
export function MediaPanel({ clips, setClips, onClipSelect, onClipRemove, onClipAdd, onPlayPause, isPlaying }: MediaPanelProps) {
      ...
      <div className="p-4 border-b border-[#3a3a3a] bg-[#2a2a2a]">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">Upload and manage your media files</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          {filteredClips.length === 0 && !searchTerm && (
            <div className="text-center py-12">
              ...
              <p className="text-lg font-medium text-gray-300 mb-2">No media files yet</p>
              <p className="text-sm text-gray-500 mb-6">Upload videos, images, or audio to get started</p>
              <Button
                onClick={() => fileInputRef.current?.click()}
          ...
          {filteredClips.length === 0 && searchTerm && (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-400 font-medium">No media found</p>
          ...
          {filteredClips.map((clip, index) => (
            <div key={`${clip.id}-${index}-${clip.name}`} className="relative">
              <div
              ...
              >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0 pr-20">
                    <p className="text-sm font-medium text-white mb-2 break-words overflow-hidden" 
                       style={{
                         display: '-webkit-box',
                         WebkitLineClamp: 2,
